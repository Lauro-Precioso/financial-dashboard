        ...
        <div className='w-11/12 max-w-md bg-white px-10 py-10 rounded-3xl border-2 border-gray-200 border-solid'>
            ...
            <div className='mt-4'>
                ...
                <div className='mt-8 flex flex-col gap-y-4'>
                    <button onClick={handleLogin} className='active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-green-500 text-white text-lg font-bold bg-gradient-to-tr from-green-500 via-emerald-500 to-teal-500 cursor-pointer'>Sign in</button>
                ...
                <div className='mt-8 flex justify-center items-center'>
                    ...
                    <button onClick={handleRegisterPage} className='bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 bg-clip-text text-transparent font-medium ml-2 cursor-pointer'>Sign up</button>
                </div>
